...
import navigationLinks from "@/constant/NavigationLink";
        ...
        <div className="flex gap-2">
          <div className="flex items-center md:hidden">
            <Popover>
              ...
              <PopoverContent align="start" className="w-48 p-0.5 md:hidden">
                ...
                {navigationLinks.map((link, index) => (
                  <NavigationMenuItem key={index} className="h-full">
                    <NavigationMenuLink
                      ...
                      href={link.href}
                      className={cn(
                        "h-full justify-center rounded-none py-1.5 font-medium text-muted-foreground hover:border-b-primary hover:bg-transparent hover:text-primary data-[active]:border-b-primary data-[active]:bg-transparent!",
                        link.active &&
                          "border-y-2 border-transparent border-b-primary "
                      )}
                    >
                      {link.label}
                    </NavigationMenuLink>
        ...
        <div className="flex items-center gap-4">
          <div>
            <div className="relative inline-grid h-7 grid-cols-[1fr_1fr] items-center text-sm font-medium">
              ...
              <span className="pointer-events-none relative me-0.5 flex w-6 items-center justify-center text-center transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] peer-data-[state=checked]:-translate-x-full peer-data-[state=checked]:text-background peer-data-[state=unchecked]:invisible peer-data-[state=checked]:rtl:translate-x-full">
